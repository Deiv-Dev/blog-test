...
class __TwigTemplate_34d953af08c61833eb4502aa4a237b4b extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">View</a>
                <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article_update_view", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            <div class=\"btn-group\">
                ...
                <a href=\"{{ path('article_update_view', {id: article.id}) }}\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            </div>
...
", "_partials/article-card.html.twig", "A:\\Coding\\homework-main\\code\\templates\\_partials\\article-card.html.twig");
    }
}
